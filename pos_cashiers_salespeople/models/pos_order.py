...
class PosOrder(models.Model):
    ...
    def _process_order(self, order, existing_order):
        """
        Sobrescribir el método _process_order para manejar el vendedor como user_id
        """
    ...
    def write(self, vals):
        """
        Sobrescribir write para sincronizar salesperson_id con user_id
        """
    ...
    def create(self, vals_list):
        """
        Sobrescribir create para establecer user_id basado en salesperson_id
        """
